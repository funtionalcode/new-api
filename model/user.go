...
type User struct {
	...
	WeeklyTokenLimit  int64                      `json:"weekly_token_limit" gorm:"type:bigint;default:0;column:weekly_token_limit"`
	MonthlyTokenLimit int64                      `json:"monthly_token_limit" gorm:"type:bigint;default:0;column:monthly_token_limit"`
...
func (user *User) EditWithTx(tx *gorm.DB, updatePassword bool) error {
	...
	updates := map[string]interface{}{
		...
		"weekly_token_limit":  newUser.WeeklyTokenLimit,
		"monthly_token_limit": newUser.MonthlyTokenLimit,
	}
	if updatePassword {
