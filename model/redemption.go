...
func Redeem(key string, userId int, clientIP string) (quota int, err error) {
	if key == "" {
	...
	RecordLog(userId, LogTypeTopup, fmt.Sprintf("通过兑换码充值 %s，兑换码ID %d", logger.LogQuota(redemption.Quota), redemption.Id), clientIP)
