...
func InitOptionMap() {
	...
	common.OptionMap["MultiDeviceLoginEnabled"] = strconv.FormatBool(common.IsMultiDeviceLoginEnabled())
	...
	common.OptionMap["TrustedProxyCIDRs"] = common.TrustedProxyCIDRs
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || strings.HasSuffix(key, "Enable") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "MultiDeviceLoginEnabled":
			common.SetMultiDeviceLoginEnabled(boolValue)
	...
	case "TrustedProxyCIDRs":
		common.TrustedProxyCIDRs = value
	case "SMTPServer":
