...
export const CHANNEL_TYPE_TYPESAFE = 66

export const CHANNEL_TYPE_VLLM = 67

export const CHANNEL_TYPE_SGLANG = 68
...
> = {
  ...
  67: { descriptionKey: 'Connect to self-hosted models served by vLLM' },
  68: { descriptionKey: 'Connect to self-hosted models served by SGLang' },
  58: { descriptionKey: 'Access Codex using ChatGPT subscription credentials' },
  59: { descriptionKey: 'Mimo' },
  63: { descriptionKey: 'Cursor' },
  65: { descriptionKey: 'ElevenLabs' },
  66: { descriptionKey: 'TypeSafe' },
} satisfies Record<
...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  26, 15, 46, 23, 18, 45, 31, 35, 59, 65, 66, 49, 19, 47, 37, 38, 39, 11, 8, 57,
  61, 22, 21, 44, 2, 5, 36, 50, 51, 52, 53, 54, 55, 56, 58, 67, 68,
]
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  67: 'vLLM API key, or EMPTY if authentication is disabled',
  68: 'SGLang API key, or EMPTY if authentication is disabled',
}
