...
describe('ElevenLabs channel registration', () => {
  test('registers ElevenLabs as a model-fetchable TTS channel', () => {
    expect(
    ...
    expect(getChannelTypeConfig(CHANNEL_TYPE_ELEVENLABS)).toMatchObject({
