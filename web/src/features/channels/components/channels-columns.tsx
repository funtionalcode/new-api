...
export function BalanceCell({ channel }: { channel: Channel }) {
  ...
  } else if (sensitiveVisible && (channel.type === 57 || channel.type === 58)) {
  ...
  } else if (channel.type === 57 || channel.type === 58) {
  ...
  if (channel.type === 57 || channel.type === 58 || isInferenceChannel) {
      ...
      <div className='-ml-1.5 flex items-center gap-1'>
        ...
        <Tooltip>
          ...
          <TooltipContent>
            ...
            {channel.type !== 57 && channel.type !== 58 && !isInferenceChannel && (
