...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/dashboard/tokens': { section: 'console', module: 'detail' },
  ...
  '/cliproxy-auth-files': { section: 'admin', module: 'authFiles' },
  '/glm-quota': { section: 'admin', module: 'glmQuota' },
  '/deepseek-quota': { section: 'admin', module: 'deepseekQuota' },
