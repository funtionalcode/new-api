...
func Setup2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLog(userId, model.LogTypeSystem, "开始设置两步验证", common.GetClientIP(c))
...
func Enable2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLog(userId, model.LogTypeSystem, "成功启用两步验证", common.GetClientIP(c))
...
func Disable2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLog(userId, model.LogTypeSystem, "禁用两步验证", common.GetClientIP(c))
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLog(userId, model.LogTypeSystem, "重新生成两步验证备用码", common.GetClientIP(c))
