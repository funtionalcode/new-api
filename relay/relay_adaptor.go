...
import (
	...
	"github.com/QuantumNous/new-api/relay/channel/codexchat"
...
func GetAdaptor(apiType int) channel.Adaptor {
	...
	case constant.APITypeCodexChat:
		return &codexchat.Adaptor{}
...
func getTaskAdaptorForRequest(c *gin.Context, platform constant.TaskPlatform) (constant.TaskPlatform, channel.TaskAdaptor) {
	if isXAITaskPlatform(platform) {
		return platform, &taskxai.TaskAdaptor{}
	}
	if c != nil {
...
func isXAITaskPlatform(platform constant.TaskPlatform) bool {
	return platform == constant.TaskPlatform(strconv.Itoa(constant.ChannelTypeXai))
}
