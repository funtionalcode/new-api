...
func CacheGetRandomSatisfiedChannel(param *RetryParam) (*model.Channel, string, error) {
	...
	filters = append(filters,
		dto.ChannelFilter{Kind: dto.FilterRequestPath, RequestPath: param.RequestPath},
		dto.ChannelFilter{Kind: dto.FilterUserAccess, UserId: common.GetContextKeyInt(param.Ctx, constant.ContextKeyUserId)},
	)
